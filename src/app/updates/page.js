...
const updates = [
  ...
  { date: '2025-10-05', title: 'Platform UIs', notes: ['Pixel-accurate LinkedIn & Facebook composers', 'Character counters & simulated engagement'] },
];
  ...
  return (
    <div className="container mx-auto px-4 py-10 animate-fade-in">
      ...
      <div className="space-y-4">
        {updates.map((u) => (
          <div key={u.date} className="rounded-xl border bg-card p-5 shadow-sm animate-slide-up">
